...
if __name__ == "__main__":
    ...
    gui.title("PASSWORD detector")

    # Set the configuration of GUI window
    gui.geometry("300x400")

    # create a label : Enter Your Task
    enterText = Label(gui, text="Enter Your password",
                      bg="light green")

    # create a text area for the root
    # with lunida 13 font
    # text area is for writing the content
    textArea = Text(gui, height=3, width=25, font="lucida 13")

    # create a Submit Button and place into the root window
    # when user press the button, the command or
    # function affiliated to that button is executed
    check = Button(gui, text="Check Password", fg="Black",
                   bg="Red", command=detect_sentiment)

    # Create a negative : label
    negative = Label(gui, text="Password was rated as: ",
                     bg="light green")

    # Create a neutral : label
    neutral = Label(gui, text="Password was rated as: ",
                    bg="light green")

    # Create a positive : label
    positive = Label(gui, text="Password was rated as: ",
                     bg="light green")

    # Create a overall : label
    overall = Label(gui, text="Password Overall Rated As: ",
                    bg="light green")
